...
namespace QLCF.Controllers
{
    ...
    {
        private readonly ThanhToanBUS _bus;
        ...
        [HttpPost("add")]
        public IActionResult Add([FromBody] ThanhToan tt)
        {
            var msg = _bus.Add(tt);
            return Ok(msg);
        }
        ...
        [HttpPut("update")]
        public IActionResult Update([FromBody] ThanhToan tt)
        {
            var msg = _bus.Update(tt);
            return Ok(msg);
        }
